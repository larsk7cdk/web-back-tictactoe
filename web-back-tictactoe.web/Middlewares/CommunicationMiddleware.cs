...
namespace TicTacToe.Middlewares
{
    public class CommunicationMiddleware
    {
        ...
        public async Task ProcessEmailConfirmation(HttpContext context, WebSocket currentSocket, CancellationToken ct,
            string email)
        {
        ...
        private async Task ProcessGameInvitationConfirmation(HttpContext context, WebSocket webSocket,
